...
<div id="wrapper" class="flex h-screen bg-grey-lightest sm:flex-col md:flex-row font-light w-full">
        <div id="sidebar" class="bg-red-800 md:w-44 overflow-y-scroll sm:w-screen">
            <header class="flex justify-between items-center border-b border-orange-darkest pt-8 pb-8 pl-6 pr-6">
                <div id="logo">
                    <a href="#" class="no-underline text md:text-2xl sm:text-4xl font-bold">
                        <img src="#" width="120" alt="">
                        kissTheme
                    </a>
                </div>
                {{-- <div id="collapse" class="text border border-white p-2 h-8 rounded">
            ...
            <div id="profile" class="flex items-center border-b border-orange-darkest px-8 py-6">
                ...
                <div id="welcome" class="  text-grey-900 w-12/4 sm:ml-1 md:ml-0">
            ...
            <ul id="menu" class="flex flex-col list-reset sm:hidden md:block">
                <li class="block">
                    <a href="#" class="no-underline text block h-full w-full border-b border-orange-darkest px-4 py-4 hover:text-orange">
                ...
                <li class="block">
                    ...
                    <ul class="flex flex-col list-reset bg-orange-darkest block">
                        <li class="flex block border-b border-orange-darker">
                            <a href="#" class="no-underline text block h-full w-full ml-1 hover:text-red-100 px-4 py-4">
                        ...
                        <ul class="flex flex-col list-reset bg-grey-900 block">
                            <li class="flex block border-b border-orange-darker">
                                <a href="#" class="no-underline text-grey-900 block h-full w-full ml-1 hover:text-orange px-4 py-4">
                                    <i class="fa fa-envelope-o mr-2" aria-hidden="true"></i>
                                    Social
                                </a>
                            </li>
